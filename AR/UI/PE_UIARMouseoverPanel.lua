-- ##################################################
-- AR/UI/PE_UIARMouseoverPanel.lua
-- Mouseover dossier, same skin as Target.
-- ##################################################

local MODULE = "AR Mouseover Panel"
...
AR.MouseoverPanel = UnitPanel.Create{
    unitToken   = "mouseover",
    layoutKey   = "mouseoverPanel",
    moduleKey   = MODULE,
    moduleName  = "AR Mouseover Panel",
    size        = { w = 260, h = 300 },
    modelHeight = 220,
    showPowerBar = true,

    nameFunc    = function(unit) return UnitName(unit) or "Mouseover" end,
